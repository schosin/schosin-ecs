...
public final class ExclusiveEntityRelationMapperImpl<R extends Exclusive> extends AbstractEntityRelationMapper<R, EntityRelation<R>, ExclusiveEntityRelationData<R>>
        implements ExclusiveEntityRelationMapper<R> {

    private final ExclusiveEntityRelationType<R> componentType;
    ...
    @Override
    public ExclusiveEntityRelationType<R> componentType() {
