...
public class CompositionManagerGenerator {
    ...
    private static final ClassName COMPOSITION = ClassName.get("de.schosin.ecs.api.components", "Composition");

    private static final ClassName COMPOSITION_MANAGER = ClassName.get("de.schosin.ecs.engine.compositions", "CompositionManager");
