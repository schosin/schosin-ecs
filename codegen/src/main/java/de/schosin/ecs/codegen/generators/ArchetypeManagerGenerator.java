...
public class ArchetypeManagerGenerator {
    ...
    public static final ClassName ARCHETYPE = ClassName.get("de.schosin.ecs.api.archetype", "Archetype");
    ...
    private static class Initialize {
        ...
        private static MethodSpec getComponent() {
            return MethodSpec.methodBuilder("get")
                    ...
                    .addStatement("return componentManager.getData(component).getInstance()")
                    .build();
        }
