...
public class TransmutationManagerGenerator {
    ...
    public static final ClassName TRANSMUTER = ClassName.get("de.schosin.ecs.plugins.transmuter", "Transmuter");
    ...
    public static final ClassName TRANSMUTER_MANAGER = ClassName.get("de.schosin.ecs.plugins.transmuter", "TransmuterManager");
    public static final ClassName ABSTRACT_ADD_TRANSMUTER = TRANSMUTER_MANAGER.nestedClass("AbstractAddTransmuter");
    ...
    private static class BaseTransmutationManager {
        ...
        private static final ClassName NAME = ClassName.get("", "BaseTransmuterManager");
        ...
        private static MethodSpec getTransmuter() {
            var transmuterT = TypeVariableName.get("T", TransmuterGenerator.TRANSMUTATION_MANAGER_ABSTRACT_TRANSMUTER);
