...
class ComponentSetSystemTest {
    ...
    abstract class AbstractTest<T extends CompositionWorld> extends AbstractSystemPluginTest<T> {
        ...
        private class TestSystem extends ComponentSetSystem<TestComponents, TestComponents.Processor> implements TestComponents.Processor {

            private final IntBag processed = new IntBag(8);

            public TestSystem(CompositionWorld world) {
                super(world, TestComponents.TYPE);
            }

            @Override
            @ComponentSetConfig("TestComponents")
        ...
        private class InsertedTestSystem extends ComponentSetSystem<TestComponents, TestComponents.Processor> implements TestComponents.Processor {
        ...
        private class RemovedTestSystem extends ComponentSetSystem<TestComponents, TestComponents.Processor> implements TestComponents.Processor {
        ...
        private class InvalidTestSystem extends ComponentSetSystem<TestComponents, TestComponents.Processor> {
